...
\BeginKnitrBlock{rmdtip}<div class="rmdtip">Como leitura complementar sobre as esferas do sistema climático recomenda-se a leitura do [Capítulo 1](http://ead06.proj.ufsm.br/moodle/mod/resource/view.php?id=316666) do Livro *Terrestrial Hydrometeorology* (@Shuttle2012).</div>\EndKnitrBlock{rmdtip}
-->
...
O $T_{r}$ fornece um indicação do tempo necessário para substituir toda água do reservatório. A água nos oceanos tem um tempo de residência de $\approx$ 3000 anos, enquanto o da água dos rios é de 0,05 anos ou  $\approx$ 17 dias. O $T_{r}$ água na atmosfera é de somente 0,02 anos (ou $\approx$ 8 dias), ou seja, um dos reservatórios mais dinâmicos do ciclo hidrológico e contribui muito para a variabilidade do sistema. 
...
<div class="figure" style="text-align: center">
<img src="images/DivFluxVaporAnual-Peixoto.jpg" alt="(ref:div-hor-vapor)" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="images/2-balanco-global.png" alt="(ref:balan-global)" width="70%" />
...
</div>Fonte: [COMET website](http://meted.ucar.edu/) UCAR, NOAA.
